...
public:
	...
	void AddEntry(const Move& best, uint64_t ZobristKey, int Score, int Depth, int Turncount, int distanceFromRoot, int fiftyMove, EntryType Cutoff);
	TTEntry GetEntry(uint64_t key, int distanceFromRoot, int fiftyMove) const;
